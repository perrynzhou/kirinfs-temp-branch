...
static const uchar *stl_md5_body(stl_md5 *ctx, const uchar *data,
                                 size_t size);
...
void stl_md5_checksum(stl_md5 *ctx, char result[16])
{
    ...
    temp[0] = (uchar)ctx->a;
    temp[1] = (uchar)(ctx->a >> 8);
    temp[2] = (uchar)(ctx->a >> 16);
    temp[3] = (uchar)(ctx->a >> 24);
    temp[4] = (uchar)ctx->b;
    temp[5] = (uchar)(ctx->b >> 8);
    temp[6] = (uchar)(ctx->b >> 16);
    temp[7] = (uchar)(ctx->b >> 24);
    temp[8] = (uchar)ctx->c;
    temp[9] = (uchar)(ctx->c >> 8);
    temp[10] = (uchar)(ctx->c >> 16);
    temp[11] = (uchar)(ctx->c >> 24);
    temp[12] = (uchar)ctx->d;
    temp[13] = (uchar)(ctx->d >> 8);
    temp[14] = (uchar)(ctx->d >> 16);
    temp[15] = (uchar)(ctx->d >> 24);
...
static const uchar *
stl_md5_body(stl_md5 *ctx, const uchar *data, size_t size)
{
    uint32_t a, b, c, d;
